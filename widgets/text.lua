...
local function generate_markup(self)
	...
	self:set_markup_silently(bold_start
		.. italic_start
		.. "<span foreground='" .. self._private.color .. "'>" .. self._private.text.. "</span>"
		.. italic_end
		.. bold_end)
end
...
--- @return Widget
--- @param args {height: number, width: number, font: string}
function text.new(args)
	...
	args.color = args.color or beautiful.light
